...
export function testWrapperForRouterPath(wrapper: Wrapper<any>, routerPathName: string): void {
  const matchingPaths = routes.filter((route: any) => route.name === routerPathName);
